...
class Problem:
    ...
    def isCSP(self):
        """
        Returns True if this is a satisfaction problem, False otherwise.
        """
        return self.solve == 'sat'

    def isCOP(self):
        """
        Returns True if this is an optimization problem, False otherwise.
        """
    ...
    def bound_worse_than(self, bound):
        """
        Returns True iff the current best bound is worse than bound:
